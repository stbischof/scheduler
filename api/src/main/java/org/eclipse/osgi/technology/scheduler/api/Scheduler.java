...
public interface Scheduler extends Executor {
    ...
    /**
     * Schedule a runnable to run periodically at a fixed rate. The schedule can be
     * canceled by the returned task.
     *
     * @param runnable      the task to run
     * @param name          The name of the task
     * @param fixedRateInMs The fixed rate in milliseconds.
     *
     */
    ...
    /**
     * Schedule a runnable to run after a certain time. The schedule can be canceled
     * by the returned task if it was not yet canceled.
     *
     * @param name     The name of the task
     * @param runnable the task to run
     * @param afterMs  time in ms after the run is scheduled.
     */
     ...
     * @param name     The name of the task
     * @param runnable the task to run
     * @param after    duration after the run is scheduled.
     */
    ...
    /**
     * Return a {@link TemporalAdjuster} based on a Cron expression. You can use a
     * Temporal Adjust to calculate the time beteween a date time and the next
     * trigger point.
     *
     * <pre>
