...
import org.eclipse.osgi.technology.scheduler.basic.provider.CentralScheduler;
import org.eclipse.osgi.technology.scheduler.basic.provider.SchedulerImpl;
...
public class SchedulerImplTest {
    ...
    public void testExecute() throws InterruptedException {
        ...
        try {
            ...
            Awaitility.await().until(() -> thread.get() != null);

            assertThat(thread.get().getName().equals("execute"));
            cdl.countDown();
